...
word_embedding_model="saved_objects/word2vec.bin"
lm_enc_dim=200
lm_dec_dim=600
lm_dec_layer_size=1
lm_attend_dim=25
...
doc_lines=4 #total number of lines for a sonnet
...
###input/output###
output_dir="output"
train_data="saved_objects/limericks_deepspeare_train.txt"
valid_data="saved_objects/limericks_deepspeare_test.txt"
test_data=False
